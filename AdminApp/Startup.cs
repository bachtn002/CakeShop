...
// Làm thế nào để login :
// Khi nhấn đăng nhập, BackendAPI được gọi đến và trả về 1 chuỗi token 
// Sau đó thực hiện tạo claim và đăng nhập
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddAuthentication(CookieAuthenticationDefaults.AuthenticationScheme)
                .AddCookie(options =>
                {
                    ...
                    //options.Cookie.Name = "BachCookie";
                });
